...
client.conf = {
 "pref": "prefix",
  "own": "sahipid",
  "oynuyor": "oynuyorkısmı",
  "durum": "durumu"//online, dnd gibi gibi
}
...
if(message.author.bot) return;
  if(message.channel.id !== 'Kanal İD') return;
if(message.content.startsWith('.')) return;
if(message.content.split(" ").length > 1) return message.channel.send('Kelime yazman lazım.').then(msg => {
